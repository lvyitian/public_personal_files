...
public class SecondActivity extends AppCompatActivity {
    private static volatile SecondActivity instance;
    {
    ...
    public TextView demo_text1,demo_text2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.btn_to_home.setOnClickListener(Action.of(this::finish)::run);
    }

    @FunctionalInterface
    public static interface Action<T>{
        void run(T obj);
        static <T> Action<T> of(Runnable r){return t->r.run();}
    }
    ...
    protected void onDestroy() {
        try {
            ...
            synchronized(SecondActivity.class){instance=null;}
        }
    }
